/**
 * 文件职责：提供独立的交易关系核对页面。
 * 主要内容：日期范围、候选筛选、来源证据、人工配对、关系确认与汇总导出。
...
function RelationsPanel({ start, end, english, seedId, onImport }: { onImport: () => void; start: string; end: string; english: boolean; seedId?: string }) {
