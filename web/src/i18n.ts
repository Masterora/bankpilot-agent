...
const zhCN: Messages = {
  ...
  productPages: {
    ...
    relations: { navigation: '关系核对', eyebrow: '交易证据', title: '关系核对', empty: '暂无交易关系' },
    reports: { navigation: '月度报告', eyebrow: '月度核查', title: '月度报告', empty: '报告功能尚未开放' },
    recurring: { navigation: '周期扣款', eyebrow: '周期信号', title: '周期扣款', empty: '周期识别功能尚未开放' },
    budgets: { navigation: '预算', eyebrow: '预算偏差', title: '预算', empty: '预算功能尚未开放' },
    audit: {
      navigation: '审计记录',
      eyebrow: '系统治理',
      title: '审计记录',
...
const enUS: Messages = {
  ...
  productPages: {
    ...
    recurring: { navigation: 'Recurring charges', eyebrow: 'RECURRING SIGNALS', title: 'Recurring charges', empty: 'Recurring detection is not available yet' },
    budgets: { navigation: 'Budgets', eyebrow: 'BUDGET VARIANCE', title: 'Budgets', empty: 'Budgets are not available yet' },
    audit: {
