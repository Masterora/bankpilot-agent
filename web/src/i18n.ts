...
const zhCN: Messages = {
  ...
  productPages: {
    ...
    review: {
      ...
      eyebrow: '确定性分析',
      title: '交易账本',
      description: '筛选交易 · 修正分类 · 追溯来源',
      empty: '暂无核查结果',
    },
    relations: { navigation: '关系核对', eyebrow: '交易证据', title: '关系核对', description: '仅已确认关系影响调整统计', empty: '暂无交易关系' },
    reports: { navigation: '月度报告', eyebrow: '月度核查', title: '月度报告', description: '月度收支 · 固定快照 · 来源证据', empty: '报告功能尚未开放' },
    recurring: { navigation: '周期扣款', eyebrow: '周期信号', title: '周期扣款', description: '历史扣款 · 周期确认 · 站内提醒', empty: '周期识别功能尚未开放' },
    budgets: { navigation: '预算', eyebrow: '预算偏差', title: '预算', description: '预算额度 · 统计口径 · 站内预警', empty: '预算功能尚未开放' },
    audit: {
      navigation: '审计记录',
      eyebrow: '系统治理',
      title: '审计记录',
...
const enUS: Messages = {
  ...
  productPages: {
    overview: {
      ...
      description: 'Imported entries · Confirmed relationships',
      empty: '',
    },
    agent: {
    ...
    review: {
      ...
      title: 'Ledger',
      description: 'Filter entries · Edit categories · Trace sources',
      empty: 'No review result',
    },
    relations: { navigation: 'Relationships', eyebrow: 'EVIDENCE', title: 'Relationships', description: 'Only confirmed relationships adjust totals', empty: 'No relationships' },
    reports: { navigation: 'Monthly reports', eyebrow: 'MONTHLY REVIEW', title: 'Monthly reports', description: 'Monthly totals · Saved snapshots · Evidence', empty: 'Reports are not available yet' },
    recurring: { navigation: 'Recurring charges', eyebrow: 'RECURRING SIGNALS', title: 'Recurring charges', description: 'Past charges · Confirmed cycles · In-app reminders', empty: 'Recurring detection is not available yet' },
    budgets: { navigation: 'Budgets', eyebrow: 'BUDGET VARIANCE', title: 'Budgets', description: 'Limits · Calculation basis · In-app alerts', empty: 'Budgets are not available yet' },
    audit: {
